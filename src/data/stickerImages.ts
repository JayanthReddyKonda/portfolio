...
export const STICKER_BADGES = {
  pytorch: createSvgDataUri(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width="400" height="400">
      ...
      <text x="200" y="355" font-family="monospace" font-weight="600" font-size="14" fill="#7ba05b" text-anchor="middle" letter-spacing="2">DEEP LEARNING // AI</text>
    </svg>
  `),
  ...
  fastapi: createSvgDataUri(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width="400" height="400">
      ...
      <rect width="400" height="400" rx="60" fill="url(#bg_fa)" stroke="#7ba05b" stroke-width="6"/>
      <circle cx="200" cy="200" r="140" fill="none" stroke="#7ba05b" stroke-width="2" stroke-dasharray="6 6" opacity="0.3"/>
      ...
      <text x="200" y="348" font-family="monospace" font-weight="600" font-size="14" fill="#7ba05b" text-anchor="middle" letter-spacing="2">ASYNC BACKEND // REST</text>
    </svg>
  `),
  ...
  docker: createSvgDataUri(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width="400" height="400">
      ...
      <text x="200" y="348" font-family="monospace" font-weight="600" font-size="14" fill="#7ba05b" text-anchor="middle" letter-spacing="2">CLOUD // CONTAINERS</text>
    </svg>
  `),
  ...
  qdrant: createSvgDataUri(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width="400" height="400">
      ...
      <text x="200" y="348" font-family="monospace" font-weight="600" font-size="14" fill="#7ba05b" text-anchor="middle" letter-spacing="2">VECTOR RAG // SEARCH</text>
    </svg>
  `),
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width="400" height="400">
      <defs>
        ...
        <linearGradient id="n_grad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stop-color="#7ba05b"/>
        </linearGradient>
      </defs>
      ...
      <text x="200" y="348" font-family="monospace" font-weight="600" font-size="14" fill="#7ba05b" text-anchor="middle" letter-spacing="2">REACT 19 // TURBOPACK</text>
    </svg>
  `),
  ...
  cuda: createSvgDataUri(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width="400" height="400">
      ...
      <text x="200" y="348" font-family="monospace" font-weight="600" font-size="14" fill="#7ba05b" text-anchor="middle" letter-spacing="2">GPU COMPUTE // C++</text>
    </svg>
  `),
};
