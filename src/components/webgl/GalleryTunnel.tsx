...
/**
 * @file GalleryTunnel.tsx
 * @description Gallery Tunnel — Originkit 3D WebGL Infinite Image Corridor.
 * Presets baked in with portfolio palette and interactive acceleration boost.
 */
...
const DEFAULT_IMAGES = GALLERY_ARCHITECTURES;

const DEFAULTS = {
  background: "#0d4c3c",
  lineColor: "#7ba05b",
  lineOpacity: 35,
  colors: ["#7ba05b", "#2d5a4a", "#0d4c3c", "#a4c982", "#1b4b3e", "#f4f1eb"],
  grid: 5,
  speed: 80,
  boost: 120,
  fade: 95,
...
const srcOf = (image: ImageBoxImage | string): string =>
  typeof image === "string" ? image : (image?.src ?? "");

export function GalleryTunnel(props: Partial<ImageBoxProps>) {
  const {
    images,
    colors,
...
export const ImageBox = GalleryTunnel;
